...
class StaffRepositoryImpl implements IStaffRepository {
  ...
  Future<Either<Failure, void>> createStaff(
    ...
    try {
      ...
      return Left(
        FirestoreFailure(message: e.message ?? 'Failed to create staff.'),
      );
    } catch (e) {
  ...
  Future<Either<Failure, void>> updateStaff(StaffModel staff) async {
    try {
      ...
      return Left(
        FirestoreFailure(message: e.message ?? 'Failed to update staff.'),
      );
    } catch (e) {
      return Left(FirestoreFailure(message: 'An unexpected error occurred.'));
    }
          ...
          return snapshot.docs.map((doc) {
            ...
            return StaffModel(
              ...
              phone:
                  ...
                  'N/A', // Assuming phone might be saved here
