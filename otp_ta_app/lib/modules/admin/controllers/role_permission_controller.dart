...
class RolePermissionController extends GetxController {
  ...
  final RxList<RolePermissionModel> rolePermissions =
      <RolePermissionModel>[].obs;
  ...
  Future<void> savePermissions(String role, List<String> allowedModules) async {
    ...
    result.fold(
      ...
      (_) {
        ...
        if (index != -1) {
          rolePermissions[index] = rolePermissions[index].copyWith(
            allowedModules: allowedModules,
          );
        } else {
          rolePermissions.add(
            RolePermissionModel(role: role, allowedModules: allowedModules),
          );
        }
